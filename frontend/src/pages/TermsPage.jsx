...
const TermsPage = () => {
  ...
  // Get the sections array from i18n
  // We use returnObjects: true because we are fetching an array of objects
  ...
  // Helper function to render bold text automatically
  const renderContent = (text) => {
    // If the text contains markdown-style bolding (**text**), replace it with <strong> tags
    ...
    <div className="min-h-screen bg-[#050505] text-gray-300 pt-32 pb-24 px-4 sm:px-6 relative selection:bg-[#D2042D] selection:text-white">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="mb-16 border-b border-white/10 pb-8">
          ...
          >
            {t('terms.subtitle')} • Reviuxx LLC, 1309 Coffeen Avenue, STE 1200, Sheridan, Wyoming 82801, USA
          </motion.p>
        </div>
